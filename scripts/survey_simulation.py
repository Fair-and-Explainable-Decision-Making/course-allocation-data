...
for k in {8,9,10,11,12,13,14,15}:
    ...
    # with open(f"experiments/real_input_{k}.pkl", "wb") as file:
    #     pickle.dump([qs,course, course_cap_map,course_map, all_courses, features, schedule], file)
    ...
    for seed in range(2):
        ...
        # with open(f"experiments/synthetic_input_{k}_{seed}.pkl", "wb") as file:
        #     pickle.dump([status_surveys_map, status_mbeta_map], file)
