...
boxplot_img = convert_from_path("./experiments/boxplot.pdf")[0]  # First page
hist_img = convert_from_path("./experiments/hist.pdf")[0]        # First page
...
plt.savefig("./experiments/final_stacked.jpg", bbox_inches="tight", dpi=300)
plt.savefig("./experiments/final_stacked.pdf", format="pdf", bbox_inches="tight", dpi=300)